...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_REQUEST["txtpass"])) {
        $pass = sha1($_REQUEST["txtpass"],false);
    };
    ...
    $adNeUser = new \exam\user();
    $adNeUser->setUser($userid);
    $adNeUser->setPwd($pass);
    $adNeUser->setName($name);
    $adNeUser->setEmail($email);
    $adNeUser->setAddress($address);
    $uc = new \exam\userController();
    $uc -> addNewUser($adNeUser);
}
?>
...
<div class="main alert alert-danger" style="margin-bottom: 0px;">
    <div class="row">
        <div class="col-md-1"></div>
        <div class="col-md-10">
            <div style="border-bottom: #777777 1px solid "><a href="">Trang chủ </a> &gt; Đăng ký </div>
            <div>
                <form action="" method="post" class="alert alert-light frres">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <h4>&nbsp;</h4>
                                <button type="button" class="btn btn-danger"><a href="index.php" style="list-style-type: none;text-decoration: none;color:white">Quay lại</a></button>
                                <button type="submit" class="btn btn-danger fl">Đăng ký</button>
                            </div>
                    </div>
                </form>
            </div>
