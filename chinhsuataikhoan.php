                ...
                <div class="col-md-4">
                    <ul style="margin-bottom: 0px">
                        ...
                        if (!isset($_SESSION["user"])) {
                            ...
                            echo "<li><a href='" . "taikhoan.php?id=" . $_SESSION["user"] . "' >" . $_SESSION["user"] . "</a><li><a href='unlogin.php'>ĐĂNG XUẤT</a></li>";
                        };
                        ?>
                    </ul>
                </div>
                            ...
                            <div class="offset-lg-2 col-lg-8">
                                <div  style="padding-bottom:20px;border: 1px solid gray; border-radius:5px">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 padding-10-0"><a href="updateName.php?id=<?=$id?>" class="btn btn-outline-secondary  btn-secondary" style="width: 75%">Cập Nhập Tên</a></div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 padding-10-0"><a href="updatePwd.php?id=<?=$id?>" class="btn btn-outline-secondary  btn-secondary" style="width: 75%">Cập Nhập Mật Khẩu</a></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-3 padding-10-0"><h3>Email : </h3></div>
                                        <div class="col-lg-5"><input type="text" value="  <?= $row['email']?>" style="width: 100%"></div>
                                        <div class="col-lg-4 padding-10-0"><a href="updateEmail.php?id=<?=$id?>" class="btn btn-outline-secondary  btn-secondary" style="width: 75%">Cập Nhập Email</a></div>
                                    </div><div class="row ">
                                        ...
                                        <div class="col-lg-4 padding-10-0"> <a href="updateAddress.php?id=<?=$id?>" class="btn btn-outline-secondary btn-secondary"style="width: 75%">Cập Nhập Địa Chỉ</a></div>
                                    </div>
                                    </div>
                                </div>
                            </div>
...
<div class="footer">
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="row">
                <div class="col-md-3">
                    <h1>Về Chúng tôi</h1>
                    <h6>Dụng cụ nghề Hoàng Long là nơi cho bãn thỏa sức mua sắm dụng cụ làm bánh mà không lo về giá.</h6>
                    <h6><img src="images/map-marker.svg" alt="" width="10px">  46 - Võ Thị Sáu - P. Quyết Thắng - TP Biên Hòa - Đồng Nai</h6>
                    <h6><img src="images/phone.svg" alt="" width="10px">  0917 701 001 - 0888 021 011 - dụng cụ bếp bánh</h6>
                ...
                <div class="col-md-3">
                    ...
                    <div id="fb-root">
                        <div class="fb-page" data-href="https://www.facebook.com/aptechvietnam.com.vn/" data-tabs="timeline" data-width="300" data-height="200" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/aptechvietnam.com.vn/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/aptechvietnam.com.vn/">Hệ thống Đào tạo Lập trình viên Quốc tế Aptech</a></blockquote></div>
                    </div>
                </div>
                <div class="col-md-3">
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <h6>Phát Triển Bởi :
                <li style="display: inline-block;"><a href="https://www.facebook.com/lehuy.roxyproduction">Lê Huy</a></li></h6>
