                ...
                <div class="col-md-4">
                    <ul style="margin-bottom: 0px">
                        ...
                        if (!isset($_SESSION["user"])) {
                            ...
                            echo "<li><a href='" . "taikhoan.php?a=0&id=" . $_SESSION["user"] . "' >" .$name. "</a><li><a href='unlogin.php'>ĐĂNG XUẤT</a></li>";
                        };
                        ?>
                    </ul>
                </div>
...
<?php switch ($a) {
    ...
    case 0:
        include "modules/accUser/mAccount.php";//gọi giao diện trang chủ
        break;
    case 1:
        include "modules/accUser/editAccount.php";//gọi giao diện chỉnh sửa tài khoản
        break;
    case 2:
        include "modules/accUser/updateName.php";//gọi giao dine65 trang sản phẩm
        break;
    case 3:
        include "modules/accUser/updatePwd.php";//gọi giao diện chỉnh sửa mật khẩu
        break;
    case 4:
        include "modules/accUser/updateEmail.php";//gọi giao diện chỉnh sửa email
        break;
    case 5:
        include "modules/accUser/updateAddress.php";//gọi giao diện chỉnh sửa dịa chỉ
        break;
    default;
