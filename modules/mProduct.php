...
$sql=' SELECT masanpham , tensanpham ,giasanpham , xuatxu , baohanh , giasanpham,motasanpham,hinhanh, tinhtrang FROM chitietsanpham  ';
...
if($result->num_rows>0){
    ...
    while($row=mysqli_fetch_array($result)){
        ...
        <div class="row"   style="border: 1px aliceblue solid;border-radius: 2% ; margin: 10px;" class="padding-5" >
            ...
            <div class="col-lg-12 padding-10" >
                ...
                <br>
                <h2><i>Giá : <b style="color: red;">'. number_format($row["giasanpham"]).' vnđ</b></i></h2><!--Giá sản phẩm-->
