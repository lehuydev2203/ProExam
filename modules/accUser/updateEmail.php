...
<div class="main alert alert-danger" style="margin-bottom: 0px;">
    ...
    while ($row=$result->fetch_assoc()) {
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div style="border-bottom: #777777 1px solid "><a href="">Trang chủ </a> &gt; Thông tin cá nhân &gt; Cập Nhập Email</div>
                <div>
                            ...
                            <div class="offset-lg-2 col-lg-8">
                                <div align="center"  style="border: 1px solid gray; border-radius:5px">
                                    <form action="">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5" align="right" style="margin: 15px 0px;">Email :</div>
                                            <div class="col-lg-7" align="left">
                                                <input type="email" placeholder="Nhập email mới" style="width: 50%" required >
                                            </div>
                                        </div>
                                        <div class="row">
