...
<div class="main alert alert-danger" style="margin-bottom: 0px;">
    ...
    while ($row=$result->fetch_assoc()) {
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div style="border-bottom: #777777 1px solid "><a href="">Trang chủ </a> &gt; Thông tin cá nhân &gt; Cập Nhập Mật Khẩu</div>
                <div>
                                    ...
                                    <form action="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7" align="left">
                                                <input type="password" placeholder="Nhập mật khẩu cũ " style="width: 50%">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-5" align="right" style="margin: 15px 0px;" >Mật Khẩu Mới :</div>
                                            <div class="col-lg-7" align="left">
                                                <input type="password" placeholder="Nhập mật khẩu mới" style="width: 50%">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-5" align="right" style="margin: 15px 0px;">Nhập Lại Mật Khẩu Mới:</div>
                                            <div class="col-lg-7"align="left">
                                                <input type="password" placeholder="Nhập lại mật khẩu mới" style="width: 50%">
                                            </div>
                                        </div>
                                        <div class="row">
