...
<div class="main alert alert-danger" style="margin-bottom: 0px;">
    ...
    while ($row=$result->fetch_assoc()) {
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div style="border-bottom: #777777 1px solid "><a href="">Trang chủ </a> &gt; Thông tin cá nhân &gt; Cập Nhập Tên</div>
                <div>
                        ...
                        <div class="row">
                            <div class="offset-lg-2 col-lg-8">
                                <div align="center"  style="border: 1px solid gray; border-radius:5px">
                                    <form action="">
                                        <h1 class="alert alert-success">Cập Nhập Tên</h1>
                                        <div class="row">
                                            <div class="col-lg-5" align="right" style="margin: 15px 0px;">Tên :</div>
                                            <div class="col-lg-7" align="left">
                                                <input type="text" placeholder="<?=$row['name']?>" style="width: 50%">
                                            </div>
                                        </div>
                                        <div class="row">
