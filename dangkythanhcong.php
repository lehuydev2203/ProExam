        ...
        <div class="col-md-10">
            ...
            <div>
                <form action="" method="post" class="alert alert-light frres">
                    ...
                    <br>
                    <a href="index.php" class="btn btn-danger"style="list-style-type: none;text-decoration: none;color:white">Quay lại</a>
                </form>
            </div>
        </div>
        <div class="col-md-1"></div>
